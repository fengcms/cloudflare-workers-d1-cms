...
describe('Property 9: 审计日志不可变性', () => {
    ...
    fc.assert(
      fc.property(
        ...
        () => {
          ...
          const methods1 = Object.getOwnPropertyNames(Object.getPrototypeOf(service))
            .filter(name => name !== 'constructor')
          const methods2 = Object.getOwnPropertyNames(Object.getPrototypeOf(service))
            .filter(name => name !== 'constructor')
          const methods3 = Object.getOwnPropertyNames(Object.getPrototypeOf(service))
            .filter(name => name !== 'constructor')
  ...
  it('should ensure service prototype is immutable', () => {
    fc.assert(
      fc.property(
        fc.constantFrom('update', 'delete', 'modify'),
        (methodName) => {
